...
119         MsgBox "Não foi possível estabelecer conexão com o Banco de Dados: " & UCase(cNomeBanco) & "  no servidor de dados:  " & UCase(cServer) & " . O programa não será inicializado. Contate o Suporte Técnico.", vbInformation, atSG
120         End
121     End If

122     If cn.State = 0 Then
123         MsgBox "Não foi possível estabelecer conexão com o Banco de Dados: " & UCase(cNomeBanco) & "  no servidor de dados:  " & UCase(cServer) & " . O programa não será inicializado. Contate o Suporte Técnico.", vbInformation, atSG
124         End
125     End If
