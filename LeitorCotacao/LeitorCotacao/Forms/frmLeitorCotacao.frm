...
138             MsgBox "Empresa não Localizada. Leitura não pode ser realizada.", vbInformation, "Linear Sistemas"
139             xlw.Close False
...
145         rs.Close
146     Else
147         MsgBox "Empresa não Identificada. Leitura não pode ser realizada.", vbInformation, "Linear Sistemas"
148         xlw.Close False
...
160             MsgBox "Cotação não Localizada. Leitura não pode ser realizada.", vbInformation, "Linear Sistemas"
161             xlw.Close False
...
167         rs.Close
168     Else
169         MsgBox "Cotação não identificada. Leitura não pode ser realizada.", vbInformation, "Linear Sistemas"
170         xlw.Close False
...
182             MsgBox "Fornecedor não Localizado. Leitura não pode ser realizada.", vbInformation, "Linear Sistemas"
183             xlw.Close False
...
196         rs.Close
197     Else
198         MsgBox "Fornecedor não Identificado. Leitura não pode ser realizada.", vbInformation, "Linear Sistemas"
199         xlw.Close False
...
261     MsgBox "Leitura Concluída. O arquivo de origem foi movido e renomeado para o caminho:" & vbNewLine & vbNewLine & Arquivo, vbInformation, "Linear Sistemas"
Fim:
...
Err_XLS:
        If Err.Number = 9 Then
            MsgBox "Há um erro com o arquivo. O Nome interno da Planilha foi alterado. Entre em contato com Suporte Técnico." & vbNewLine & "Nome do Arquivo: " & Plan & ".xls", vbInformation, "Linear Sistemas"
        Else
            'If nI = 0 Then
        ...
        lblInfo.Caption = "Importação não realizada."
        xlw.Close False
        xl.Application.Quit
        Set xlw = Nothing
        Set xl = Nothing
...
104     If cServer = "" Then
105         cServer = InputBox$("Digite o Nome ou IP da máquina Servidora de Dados:")
...
110         cServer = InputBox$("Digite o Nome ou IP da máquina Servidora de Dados:")
...
137             .Library.Mensagem "Atenção!!!" & vbNewLine & "Dados de conexão com o banco de dados inválido(s)." & vbNewLine & "Servidor: " & .sglinxini.servidor & vbNewLine & "Banco: " & .sglinxini.NomeBanco & vbNewLine & "Porta: " & .sglinxini.portabanco & vbNewLine & "LinearCloud: " & .sglinxini.LinearCloud
138         End If
139     End With
